<template>
  <div class="bruce flex-ct-x" data-title="使用+或~美化选项表单">
    <ul class="beauty-selection">
      <li>
        <input type="radio" id="fed-engineer" name="radioName" hidden />
        <label for="fed-engineer"></label>
        <span>前端工程师</span>
      </li>
      <li>
        <input type="radio" id="bed-engineer" name="radioName" hidden />
        <label for="bed-engineer"></label>
        <span>后端工程师</span>
      </li>
      <li>
        <input type="radio" id="fsd-engineer" name="radioName" hidden />
