<template>
  <div class="bruce flex-ct-x" data-title="使用clip-path排版蜂窝布局">
    ...
    <div class="cellular-layout" style="--count: 16">
      ...
      <label for="a" style="--index: 1">见</label>
      <label for="a" style="--index: 2">犹</label>
      <label for="a" style="--index: 3">怜</label>
      <label for="b" style="--index: 4">爱</label>
      <label for="b" style="--index: 5">不</label>
      <label for="b" style="--index: 6">释</label>
      <label for="b" style="--index: 7">手</label>
      <label for="c" style="--index: 8">雅</label>
      <label for="c" style="--index: 9">俗</label>
      <label for="c" style="--index: 10">共</label>
      <label for="c" style="--index: 11">赏</label>
      <label for="d" style="--index: 12">君</label>
      <label for="d" style="--index: 13">子</label>
      <label for="d" style="--index: 14">好</label>
      <label for="d" style="--index: 15">逑</label>
    </div>
  </div>
</template>
